...
fig.write_html("/Users/bridg3r/Documents/GitHub/Onsemi/AllLocations.html")

FabAto = dat.query("site_type !='other'")
fig = px.scatter_geo(FabAto, lat=FabAto.Latitude, lon=FabAto.Longitude, hover_name = 'city', color = 'site_type', hover_data = ['country'])
fig.update_layout(
            title={
            'text' : 'Onsemi Footprint (Fab Sites and ATO Sites Only)',
            'x':0.5,
            'xanchor': 'center'
        })
...
fig.write_html("/Users/bridg3r/Documents/GitHub/Onsemi/FABATOLocations.html")